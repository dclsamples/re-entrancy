...
describe("Re-entrancy Attack", () => {
  it("Should empty the balance of the Good Contract", async () => {
    ...
    console.log("\tGoodContractBalance: \t" + goodContractBalance);
    ...
    console.log("\tGoodContractBalance (after attack): " + goodContractBalance);
    console.log("\tBadContractBalance: \t" + badContractBalance);
  });
});
